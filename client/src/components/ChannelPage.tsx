...
import MediaModeChip from './Subscriptions/components/chips/MediaModeChip';
import LibraryModeChip from './Subscriptions/components/chips/LibraryModeChip';
...
function ChannelPage({ token }: ChannelPageProps) {
  ...
  const globalMediaMode = config.mediaMode || 'download';
  const globalLibraryMode = config.defaultLibraryMode || 'movie';
  ...
  const handleSettingsSaved = (updated: {
    ...
    setChannel((prev) => {
      ...
      const next: Channel = {
        ...
        media_mode: updated.media_mode !== undefined ? updated.media_mode : prev.media_mode,
        library_mode: updated.library_mode !== undefined ? updated.library_mode : prev.library_mode,
      };
  ...
  return (
    <>
            ...
            <Box className="flex flex-col gap-4">
              ...
              <Box className="grid grid-cols-2 gap-3 text-sm">
                ...
                <Box className="flex flex-col gap-1">
                  ...
                  {channel ? (
                    (channel.library_mode || globalLibraryMode) === 'series' ? (
                      <Box className="flex gap-1 flex-wrap">
      ...
      <ChannelVideos
        ...
        channelMediaMode={channel?.media_mode || null}
