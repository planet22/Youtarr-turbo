...
export function useChannelVideos({
  ...
  const fetchVideos = useCallback(async () => {
    ...
    try {
      ...
      if (applyChannelFilters) {
        queryParams.append('applyChannelFilters', 'true');
      }
  ...
  }, [channelId, page, pageSize, downloadedFilter, searchQuery, sortBy, sortOrder, tabType, maxRating, token, append, resetKey, minDuration, maxDuration, dateFrom, dateTo, protectedFilter, missingFilter, ignoredFilter, watchedFilter, applyChannelFilters]);
