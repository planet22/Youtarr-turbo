...
import { QualityChip, AutoDownloadChips, DurationFilterChip, TitleFilterChip, DownloadFormatConfigIndicator, TerminatedChip, MediaModeChip, ProtectedChip ,LibraryModeChip } from './chips';
...
const ChannelCard: React.FC<ChannelCardProps> = ({
    ...
    globalMediaMode = 'download',
    globalLibraryMode = 'movie',
    onNavigate,
    onDelete,
    onRegexClick,
    isPendingAddition,
            ...
            >
                ...
                <CardContent style={{ display: 'flex', flexDirection: 'column', gap: 16, width: '100%', flexGrow: 1 }}>
                    ...
                    <CardDetails
                        channel={channel}
                        isMobile={isMobile}
                        globalMediaMode={globalMediaMode}
                        globalLibraryMode={globalLibraryMode}
                        onRegexClick={onRegexClick}
                    />
                </CardContent>
            </CardActionArea>
...
const CardDetails: React.FC<CardDetailsProps> = ({ channel, isMobile, globalMediaMode, globalLibraryMode, onRegexClick }) => {
    return (
