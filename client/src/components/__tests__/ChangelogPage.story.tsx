...
const CHANGELOG_RAW_URL =
  'https://raw.githubusercontent.com/planet22/Youtarr-turbo/main/CHANGELOG.md';
...
export const ErrorState: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    try {
      ...
      await expect(alertContent.getByRole('link', { name: /https:\/\/github.com\/planet22\/youtarr-turbo/i })).toBeInTheDocument();
