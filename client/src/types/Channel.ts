export interface Channel {
  ...
  // Per-channel override of the global mediaMode setting
  // (download/strm/both); null/undefined = inherit global.
  media_mode?: string | null;
  // Per-channel override of the global libraryMode setting
  // (movie/series); null/undefined = inherit global.
