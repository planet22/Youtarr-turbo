import { resolveLibraryDisplay, MediaServerLibrary } from '../mediaServerLibraries';

describe('resolveLibraryDisplay', () => {
  const LIBRARIES: MediaServerLibrary[] = [
    { id: '1', title: 'YouTube' },
  ...
  test('handles alphanumeric library ids in the "resolved" path', () => {
    const libs: MediaServerLibrary[] = [{ id: 'my-lib-99', title: 'My Lib' }];
