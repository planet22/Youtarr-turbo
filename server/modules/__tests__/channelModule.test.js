...
describe('channelModule facade', () => {
  ...
  describe('delegation contract', () => {
    ...
    const CASES = [
      ...
      ['getChannelVideos', '../channel/channelVideosService', 'getChannelVideos', ['UC1', 2, 25, 'only', 'q', 'title', 'asc', 'shorts', 60, 600, '2026-01-01', '2026-02-01', 'only', 'exclude', 'off', 'only', true], 'async'],
