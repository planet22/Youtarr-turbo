    ...
    for (const url of newVideoUrls) {
      ...
      if (fs.existsSync(dataPath)) {
        ...
        const videoMetadata = {
          ...
          // TV Series library mode: frozen season/episode assigned by
          // seriesEpisodeResolver during post-processing; null for movie mode.
        ...
        if (videoFilePath) {
          ...
          if (videoStats) {
            ...
            // A verified real video file means this row is no longer STRM-only,
            // even if it previously was (e.g. cache-on-play, or a channel
